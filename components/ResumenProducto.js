...
export const ResumenProducto = ({producto = {}}) => {
    ...
    const {handleEditCantidad, handleEliminarProducto} = useQuiosco();
    ...
    return (
        <div className="shadow p-5 flex gap-10 items-center">
            ...
            <div>
                <button
                    type="button"
                    className="bg-indigo-600 hover:bg-indigo-600 hover:shadow-md transition flex gap-2 items-center px-3 py-2
                    text-white rounded-md shadow font-bold w-full text-center"
                    onClick={() => handleEditCantidad(id)}
                >
                    <svg
                ...
                <button
                    type="button"
                    className="bg-red-600 hover:bg-red-600 hover:shadow-md transition flex gap-2 items-center px-3 py-2
                    text-white rounded-md shadow font-bold w-full text-center mt-2"
